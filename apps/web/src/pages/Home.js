...
export default function Home() {
  return _jsxs('div', {
    ...
    children: [
      _jsxs('section', {
        className:
          'relative bg-gradient-to-br from-primary-50 via-white to-primary-50 py-16 lg:py-24 xl:py-32 overflow-hidden',
        children: [
          ...
          _jsx('div', {
            ...
            children: _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('h1', {
                  className:
                    'text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-primary-900 mb-6 leading-tight',
                  children: [
                    'Your Gateway to',
                    _jsx('span', {
                ...
                _jsx('p', {
                  className:
                    'text-lg sm:text-xl lg:text-2xl text-gray-600 mb-8 lg:mb-10 max-w-4xl mx-auto leading-relaxed',
                  children:
                ...
                _jsxs('div', {
                  className:
                    'flex flex-col sm:flex-row gap-4 justify-center items-center mb-10 lg:mb-12',
                  children: [
                    _jsxs(Link, {
                      to: '/apply',
                      className:
                        'group inline-flex items-center space-x-3 bg-primary-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg shadow-lg hover:shadow-xl hover:bg-primary-700 transform hover:-translate-y-1 transition-all duration-200',
                      children: [
                        _jsx('span', { children: 'Start Your Application' }),
                        _jsx(ArrowRight, {
                          className:
                            'h-4 w-5 sm:h-5 sm:w-5 group-hover:translate-x-1 transition-transform duration-200',
                        }),
                      ],
                    }),
                    _jsxs(Link, {
                      to: '/status',
                      className:
                        'inline-flex items-center space-x-3 bg-white text-primary-700 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg border-2 border-primary-200 hover:border-primary-300 hover:bg-primary-50 transition-all duration-200',
                      children: [
                        _jsx(Clock, { className: 'h-4 w-5 sm:h-5 sm:w-5' }),
                ...
                _jsxs('div', {
                  className:
                    'flex flex-wrap justify-center items-center gap-4 sm:gap-6 lg:gap-8 text-sm text-gray-500',
                  children: [
                    _jsxs('div', {
        ...
        children: _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx('h2', {
                  className: 'text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-900 mb-4',
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  className:
                    'group p-6 lg:p-8 rounded-2xl border border-gray-100 hover:border-primary-200 hover:shadow-xl transition-all duration-300 bg-white',
                  children: [
                    _jsx('div', {
                      className: 'flex justify-center mb-6',
                      children: _jsx('div', {
                        className:
                          'p-3 lg:p-4 bg-primary-100 rounded-2xl group-hover:bg-primary-200 transition-colors duration-200',
                        children: _jsx(BookOpen, {
                          className: 'h-6 w-6 lg:h-8 lg:w-8 text-primary-600',
                        }),
                      }),
                    }),
                    _jsx('h3', {
                      className:
                        'text-lg lg:text-xl font-semibold text-primary-900 mb-3 lg:mb-4 text-center',
                      children: 'Easy Application Process',
                    }),
                    _jsx('p', {
                      className: 'text-gray-600 text-center leading-relaxed text-sm lg:text-base',
                      children:
      ...
      _jsx('section', {
        className: 'py-16 lg:py-20 bg-primary-600 text-white',
        children: _jsxs('div', {
          className: 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8',
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsx('div', {
                      className: 'text-primary-200 text-sm lg:text-base',
      ...
      _jsx('section', {
        className: 'py-16 lg:py-20 bg-gradient-to-r from-primary-600 to-primary-700 text-white',
        children: _jsxs('div', {
          ...
          children: [
            ...
            _jsx('p', {
              className: 'text-lg sm:text-xl mb-8 lg:mb-10 opacity-90 max-w-3xl mx-auto',
              children:
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs(Link, {
                  to: '/apply',
                  className:
                    'group inline-flex items-center space-x-3 bg-white text-primary-600 hover:bg-gray-50 font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1',
                  children: [
                ...
                _jsxs(Link, {
                  to: '/login',
                  className:
                    'inline-flex items-center space-x-3 border-2 border-white text-white hover:bg-white hover:text-primary-600 font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-xl transition-all duration-200',
                  children: [
                    _jsx(LogIn, { className: 'h-4 w-5 sm:h-5 sm:w-5' }),
        ...
        children: _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx('h2', {
                  className: 'text-2xl sm:text-3xl font-bold text-primary-900 mb-4',
