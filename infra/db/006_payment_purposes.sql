...
CREATE INDEX idx_payment_purposes_faculty ON payment_purposes(faculty_id);


-- Create unique constraint to prevent duplicate purposes per session, level and faculty
...
INSERT INTO payment_purposes (name, purpose, description, amount, session, level, faculty_id, created_at, updated_at) VALUES
('POST_UTME', 'POST_UTME', 'Application fee for Post-UTME examination', 2500.00, '2024/2025', '100', NULL, NOW(), NOW()),
('ACCEPTANCE', 'ACCEPTANCE', 'Fee for accepting admission offer', 50000.00, '2024/2025', '100', NULL, NOW(), NOW()),
('SCHOOL_FEES', 'SCHOOL_FEES', 'First year school fees', 150000.00, '2024/2025', '100', NULL, NOW(), NOW()),
('SCHOOL_FEES', 'SCHOOL_FEES', 'Second year school fees', 150000.00, '2024/2025', '200', NULL, NOW(), NOW()),
('SCHOOL_FEES', 'SCHOOL_FEES', 'Third year school fees', 150000.00, '2024/2025', '300', NULL, NOW(), NOW()),
('SCHOOL_FEES', 'SCHOOL_FEES', 'Fourth year school fees', 150000.00, '2024/2025', '400', NULL, NOW(), NOW()),
('LIBRARY_FEE', 'LIBRARY_FEE', 'Annual library access fee', 5000.00, '2024/2025', '100', NULL, NOW(), NOW()),
('HOSTEL_FEE', 'HOSTEL_FEE', 'On-campus accommodation fee', 25000.00, '2024/2025', '100', NULL, NOW(), NOW()),
('MEDICAL_FEE', 'MEDICAL_FEE', 'Health services fee', 3000.00, '2024/2025', '100', NULL, NOW(), NOW()),
('SPORTS_FEE', 'SPORTS_FEE', 'Sports and recreation fee', 2000.00, '2024/2025', '100', NULL, NOW(), NOW());
...
COMMENT ON COLUMN payment_purposes.faculty_id IS 'Faculty associated with this payment purpose';
